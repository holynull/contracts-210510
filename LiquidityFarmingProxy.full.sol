...
// File: contracts/interfaces/IBSTToken.sol
...
// File: contracts/DelegateBEP20.sol

pragma solidity ^0.6.0;
pragma experimental ABIEncoderV2;


abstract contract DelegateBEP20 is BEP20Burnable {
    ...
    */
    ...
    external
    {
        ...
        require(signatory != address(0), "DelegateToken::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DelegateToken::delegateBySig: invalid nonce");
        require(now <= expiry, "DelegateToken::delegateBySig: signature expired");
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "DelegateToken::getPriorVotes: not yet determined");
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "DelegateToken::_writeCheckpoint: block number exceeds 32 bits");
